const KognitiveProzesseListe = [
    ExekutiveFunktionen = {
        ...
        Beschreibung: "Zu den exekutiven Funktionen werden in der Neuropsychologie kognitive Prozesse gezählt, die unser Verhalten, unsere Emotionen und unsere Aufmerksamkeit gezielt steuern. Sie haben direkten Einfluss auf unser Arbeitsgedächtnis, die Reaktionshemmung und die flexible Aufmerksamkeitssteuerung. \n\n"+
        ...
        Uebungen:[
            {
                ...
                Info:"Das 3-Minuten-Breathing Space bringt dich aus deinem eigentlich habitualisierten Verhalten bewusst in den jetzigen Moment. Die Übung kann dir dabei helfen, stressige Situationen besser zu bewältigen.\n"+  
                ...
                Effekt:"Im ersten Schritt gilt es die Aufmerksamkeit auf sich selbst, seine Gedanken und Gefühle zu richten und sich mit diesen auseinandersetzen. Der zweite Schritt lenkt dann die Aufmerksamkeit allein auf die Atmung, was meist eine beruhigende Wirkung hat. Der Übergang von Schritt 1 zu 2 zielt auch darauf ab, mögliche aufkommende negative Gedanken und Gefühle loszulassen.\n\n"+ 
            ...
            },
            {
                ...
                Allgemeines:"Die Grounding Exercices fassen eine große Spannweite an Übungen unter diesem Sammelbegriff zusammen. Das Ziel dieser Übung ist es, dass die ausübende Person sich „erden“ kann, sodass sie sich auf das Hier und Jetzt konzentriert. Eine dieser Übungen beinhaltet die Aufgabe, sich auf einen bestimmten der fünf Sinne gezielt zu konzentrieren und bewusst alle Sinneseindrücke wahrzunehmen.\n\n"+ 
                "Ein weiteres Ziel der Übung ist es, in überwältigenden oder schwierigen Situationen von negativen Gedankenmustern loszukommen, in dem man sich nur auf das konzentriert, was man in genau diesem Moment hört, sieht, fühlt, riecht oder schmeckt.  ",
                Herkunft:"Da die Grounding Exercices viele unterschiedliche Übungen beschreiben, lässt sich eine genaue Herkunft nicht bestimmen. Da viele dieser Übungen aber einen meditativen Charakter haben, lässt sich annehmen, dass sie am Buddhismus angelehnt sind.",
            ...
            },
            {
                ...
                Audio: false,
                Kategorie:"Atemübung",
                Beschreibung:"1) Setze oder lege dich in eine bequeme Position, auf deinem Bett oder einer flachen Unterlage.\n\n"+
                ...
                KognitiveProzesse: [dispositionaleAchtsamkeit, Stresswahrnehmung],
                Allgemeines:"Abdominal Breathing oder auch Bauchatmen, ist eine Atemtechnik, die man gut in den Alltag integrieren kann und sich besonders mit einer gezielten Übung trainieren lässt.\n\n"+
        ...
        Uebungen:[
            {
                ...
                "Da es gerade für Meditationsneulinge oft schwierig ist, sich über die Dauer der Sitzung ausschließlich auf die Meditation zu konzentrieren, eignet sich die Klangschalen-Mediation hier besonders gut. Man wird für die Dauer der Meditation mit seinen Gedanken und der Stille nicht alleine gelassen. Dies kann eine Konzentration erschweren. Deswegen wird man hier von harmonischen Klängen begleitet, die die Aufmerksamkeit lenken. ",
                ...
                "Die Klangschalen-Meditation hat ebenso wie die Klangschalen selbst ihren Ursprung in Tibet, China. Dort hat diese Art der Meditation eine lange Tradition: Die Klangschalen wurden so konzipiert, dass sie eine bestimmte, wohlklingende Frequenz treffen, der eine positive Wirkung auf Körper und Geist nachgesagt wird. ",
            ...
            },
            {
                ...
                KognitiveProzesse: [dispositionaleAchtsamkeit, Stresswahrnehmung],
                Allgemeines:"Beim Breathing Anchor handelt es sich um eine geführte Achtsamkeitsübung, bei der der Fokus auf dem Körper und dessen Wahrnehmungen und vor allem auf dem Atem liegt.\n\n"+ 
                ...
                "Es kann außerdem hilfreich sein, die Hände am Ankerpunkt (etwa dem Bauch, der Nase oder dem Brustkorb) zu platzieren, da es dadurch leichter wird sich auf diesen Punkt zu konzentrieren. ",
                Herkunft:"Viele Achtsamkeitsübungen, wie auch der Breathing Anchor, sind modernisierte und abgewandelte Formen von Atemtechniken, die bereits seit tausenden Jahren in unterschiedlichsten Kulturen auf der ganzen Welt, etwa im alten Griechenland oder in Indien, gelehrt und angewandt wurden.\n\n"+
                ...
                Effekt:"Der Breathing Anchor eignet sich gut als Einstiegsübung in das weite Feld der Achtsamkeitstechniken, da die, für Übungen nötige, Konzentration gestärkt wird, indem man sich darauf trainiert, nur auf ein einzelnes Objekt, den Atem, zu fokussieren.\n\n"+ 
            ...
            {
                id:"PPKurs_2_3",
                Name:"Geführte Meditation mit Fokus Atem (kurz)",
                Audio: true,
                Kategorie:"Meditationen",
                Beschreibung:"Bei dieser Übung wirst Du geleitet. Hier konzentrierst Du dich auf deinen Atem.",
                Info:"Diese Mediation soll dir helfen dein Stress-Level zu reduzieren. Allein durch das bewusste Beobachten des Atems wird sich dein Empfinden verändern.\n"+  
                "Menschen, die gestresst sind, atmen in der Regel schneller und flacher und damit weniger effektiv. Denn unter Stress bereitet sich der Körper auf eine bevorstehende bedrohliche Situation vor. In dem Du deinem Atem Aufmerksamkeit schenkst, wirst Du automatisch bewusster und möglicherweise langsamer atmen. Dadurch wird dein Atem durch erhöhte Sauerstoffzufuhr effizienter und dein Körper entspannt sich. \n"+
                "Zusätzlich kannst Du wichtige kognitive Funktionen, wie die Handlungsüberwachung, die Du auch für diese Übung brauchst, stärken. Denn so, wie die meisten Meditationsformen deine exekutiven Funktionen verbessern, hilft auch diese Atemübung dir dabei, bewusster und gezielter deine Aufmerksamkeit, wie hier auf den Atem, zu steuern. ",
        ...
        Uebungen:[
            {
                ...
                Audio: true,
                Kategorie:"Meditationen",
                Beschreibung:"Bei dieser Übung wirst Du geleitet. Hier konzentrierst Du dich noch intensiver auf den Atem.",
                Info:"Diese Mediation soll dir helfen dein Stress-Level zu reduzieren. Allein durch das bewusste Beobachten des Atems wird sich dein Empfinden verändern.\n"+  
                "Menschen, die gestresst sind, atmen in der Regel schneller und flacher und damit weniger effektiv. Denn unter Stress bereitet sich der Körper auf eine bevorstehende bedrohliche Situation vor. In dem Du deinem Atem Aufmerksamkeit schenkst, wirst Du automatisch bewusster und möglicherweise langsamer atmen. Dadurch wird dein Atem durch erhöhte Sauerstoffzufuhr effizienter und dein Körper entspannt sich. \n"+
                "Zusätzlich kannst Du wichtige kognitive Funktionen, wie die Handlungsüberwachung, die Du auch für diese Übung brauchst, stärken. Denn so, wie die meisten Meditationsformen deine exekutiven Funktionen verbessern, hilft auch diese Atemübung dir dabei, bewusster und gezielter deine Aufmerksamkeit, wie hier auf den Atem, zu steuern. ",
                KognitiveProzesse: [ExekutiveFunktionen, Stresswahrnehmung],
            ...
            },
            {
                ...
                Audio: true,
                Kategorie:"Körperübung",
                Beschreibung:"Hier wird dein Bewusstsein mithilfe deines Körpers trainiert.",
